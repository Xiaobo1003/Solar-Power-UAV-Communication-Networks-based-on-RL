...
class Maze():
    ...
    def reset(self):
        ...
        self.rect15 = [Battery, S0, T0]
        self.rect16 = [Battery, S0, T0]
        # self.rect8 = ([Battery, S0, T0])
        # input 012
        # 5个input 维度
        self.count = 0

        return self.rect0 + self.rect1 + self.rect2 + self.rect3 + self.rect4 + self.rect5 + self.rect6 + self.rect7 + self.rect8 + self.rect9 + self.rect10 + self.rect11 + self.rect12 + self.rect13 + self.rect14 + self.rect15 + self.rect16
    ...
    def getstate(self):
        ...
        self.rectm15 = [self.rect15[0]] + [self.rect15[1]]
        self.rectm16 = [self.rect16[0]] + [self.rect16[1]]
        self.T = [self.rect0[2]]
        return self.rectm0 + self.rectm1 + self.rectm2 + self.rectm3 + self.rectm4 + self.rectm5 + self.rectm6 + self.rectm7 + self.rectm8 + self.rectm9 + self.rectm10 + self.rectm11 + self.rectm12 + self.rectm13 + self.rectm14 + self.rectm15 + self.rectm16 + self.T
    ...
    def step(self, action):
        ...
        s_lis = [s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16]
        # s_all = [s0,s1,s2]
        base_action = np.array([[0, 0, 0] for i in range(17)])
        s = action
        ...
        self.rect15 = self.rect15 + base_action[15]
        self.rect16 = self.rect16 + base_action[16]
        s_16 = list(self.rect16)
        s_15 = list(self.rect15)
        ...
        if s_T == 5 or s_T == 21:
            ...
            if relax_count >= 10:
                ...
                reward_relax += min(1 * relax_count, 15)  # 线性
        ...
        if s_T == 7:
            ...
            if relax_count >= 6:
                ...
                reward_relax += min(1 * relax_count, 11)
        if s_T == 18:
            for b in range(17):
        ...
        if s_T == 8 or s_T == 17:
            ...
            if relax_count >= 5:
                ...
                reward_relax += min(1 * relax_count, 10)
        ...
        if s_T == 9 or s_T == 10:
            ...
            if relax_count >= 3:
                ...
                reward_solar += min(3 * relax_count, 24)
        tx_count = 0
        relax_count = 0
        ...
        if s_T == 16:
            ...
            if relax_count >= 3:
                ...
                reward_relax += min(1 * relax_count, 8)
        tx_count = 0
        relax_count = 0
        ...
        if s_T == 11 or s_T == 12:
            ...
            if relax_count >= 4:
                ...
                # reward_relax += min(13.34 * relax_count, 80)
                reward_solar += min(3 * relax_count, 27)
        tx_count = 0
        relax_count = 0
        #  6,19,20 时段
        if s_T == 19 or s_T == 20 or s_T == 6 :
            ...
            if relax_count >= 8:
                ...
                reward_relax += min(1 * relax_count, 13)
        # if s_T == 6:
        #     for f in range(15):
        #         if s_Location[f] == 0:
        #             tx_count += 1
        ...
        return s_0 + s_1 + s_2 + s_3 + s_4 + s_5 + s_6 + s_7 + s_8 + s_9 + s_10 + s_11 + s_12 + s_13 + s_14 + s_15 + s_16, reward_sigle, done